  ...
  render() {
    return (
        ...
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            ...
            <a href="http://127.0.0.1:8000/admin" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
                <h5 class="my-0 mr-md-auto font-weight-normal" >Wildberies</h5>
                 <svg class="bi me-2" width="40" height="32" role="img" aria-label="Bootstrap"><use href=""/></svg>
            </a>
            ...
            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                <li><a href="http://127.0.0.1:8000/bin/" class="nav-link px-2 link-dark">Корзина</a></li>   
